          ...
          <div class="form-container">
            <el-form :model="form" label-width="100px">
              ...
              <!-- <el-form-item label="评审等级">
                <el-select v-model="form2.psLevel" placeholder="请选择评审等级">
                  <el-option label="校级" value=20></el-option>
                  <el-option label="省级" value=40></el-option>
                </el-select>
              </el-form-item> -->
              ...
              <el-form-item>
                <div style="display: flex; justify-content: center; gap: 20px">
                  ...
                  <el-button type="danger" @click="rejectForm"
                    >返回修改</el-button
                  >
                </div>
              </el-form-item>
